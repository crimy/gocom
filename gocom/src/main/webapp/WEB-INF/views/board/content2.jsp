...
<!-- content Start -->
		<h6 align="center" class="mb-4">${board.getTitle()}</h6>
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4 text-center">
                    <div class="col-sm-12 col-xl-10" style="float:none; margin:0 auto">                    
                        <div class="bg-light rounded h-100 p-4">
							<c:choose>
								<c:when test="${i_count > 1 }">	
			                       <div id="carouselControls" class="carousel slide" data-bs-ride="carousel" >
									  <div class="carousel-inner">										
										    <div class="carousel-item active">
										      <img src="<c:url value="/resources/upload/${image_first.getFsn()}"/>" class="d-block w-100" alt="...">
										    </div>
										    <c:forEach items="${image}" var="t">
										    	<div class="carousel-item">
										      		<img src="<c:url value="/resources/upload/${t.getFsn()}"/>" class="d-block w-100" alt="...">
										    	</div>
										    </c:forEach>										    
										</div>	    
	                        	...
	                        	<c:when test="${i_count == 0 }">
	                        		<img src="<c:url value="/resources/upload/no_image.png"/>" class="d-block w-100" alt="...">
	                        	</c:when>
	                        </c:choose>
                    	</div>
            	</div>
